...
Env: GH_TOKEN (PAT com escopo project), PROJECT_ID, FIELD_ID, BACKLOG, CONCLUIDO, REPO
"""
...
REPO = os.environ.get("REPO", "TipGroup-inc/TipOS-site")
...
}""" % (OWNER, NAME), n=NUM)["data"]["repository"]["issue"]
